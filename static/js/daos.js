...
//        } ]
     ...
     * thfood
     */
//      $('.daos_datagrid tfoot th').each( function () {
//        var title = $(this).text();
//        $(this).html( '<input type="text" placeholder="Buscar '+title+'" />' );
//    } );
//    
//     // Apply the search
//  var table = $('.daos_datagrid').DataTable();
// 
//    // Apply the search
...
//var datatableInstance = $('.daos_datagrid').dataTable();
//$('.daos_datagrid thead th').each(function () {
//    var title = $('.daos_datagrid tfoot th').eq($(this).index()).text();
//    $(this).html('<input type="text" placeholder="Buscar ' + title + '" />');
//});
//
...
var table = $('.daos_datagrid').DataTable();
 $('.daos_datagrid thead tr').clone(true).appendTo( '.daos_datagrid thead' );
    $('.daos_datagrid thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
