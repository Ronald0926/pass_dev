      ...
      //     if ($post) {
       ...
       // var_dump($data);
        ...
        foreach ($detalles as $x => $x_value) {
          ...
          //  if ($contador == 1) {
                $data = '
              <table border="0" style="width: 100%; padding-left: 15 px; padding-top: 2px;" >';
          //  } else {
           //     $data = '
      ...
      //     if ($post) {
       ...
       // var_dump($data);
        ...
        foreach ($detalles as $x => $x_value) {
           ...
           // } else {
            //    $data = '
           //   <table border="0" style="width: 100%; padding-left: 64px; margin-top: 327px;" >';
           // }
