    ...
    <table class="table table-bordered table-hover table-condensed">
        <thead>
            <tr>
                ...
                <th order="nombre_admin_pais">Pa&iacute;s</th>
                <th order="nombre_admin_departamento">Departamento</th>
                <th order="nombre_admin_ciudad">Ciudad</th>
        ...
        <tbody class="gridBody">
            <tr>
                ...
                <td>{nombre_admin_pais}</td>
                <td>{nombre_admin_departamento}</td>
                <td>{nombre_admin_ciudad}</td>
                <td >
                    <div>
