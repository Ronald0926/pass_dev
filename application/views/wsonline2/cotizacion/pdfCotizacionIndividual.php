...
<!--                    <td style="width: 235">
                ...
                <div><!--linea pasarela  -->
                    ...
                    <table class="table-border-0">
                        <tr>
                            ...
                            <td style="text-align: justify;">La mejor opcion en la administraci&oacute;n de pagos por incentivos, premios y bonificaciones con tarjetas recargables
                                y de una sola carga que facilitan la operacion y brindan control y seguridad para su organizaci&oacute;n. Con los productos
                                de la linea Pasarela premie y reconozca la labor de todos los impulsos comerciales que le permiten
            ...
            <div> <!--pagina caracteristicas medios de pago  -->
                ...
                <ul class='ul_medios'>
                    <li>La entrega de las tarjetas sera; en 5 dias habiles despues de solicitadas en PassOnline.</li>
                    <li>Podra; hacer pago de los productos mediante los siguientes medios: Punto PSE en PassOnline,
                        transferencia electronica, consignacion bancaria  y/o cheque en consignacion.</li>
                    <li>Los abonos tendran un tiempo maximo de 24 horas para ser aplicados debido a los tiempos de identificaci&oacute;n de los pagos.</li>
                    <li>Los medios de pago son emitidos por una entidad vigilada por la Superintendencia Financiera de Colombia.</li>
                    <li>Los medios de pago pueden ser recargables o no recargables de acuerdo a las caracteristicas de cada producto.</li>
                    <li>Los medios de pago tienen aceptacion total a nivel nacional e internacional en los establecimientos con datafono
                        vinculado a la franquicia VISA y en la red de cajeros automaticos, segun los parametros del producto.</li>
                    ...
                    <li>Para usar los medios de pago en datafonos y cajeros automaticos se debe seleccionar la opcion de tarjeta d&eacute;bito y cuenta de ahorros.</li>
                    <li>El primer env&iacute;o de tarjetas del mes a un unico destino es gratuito.</li>
                    <li>El monto maximo de retiro diario en la red de cajeros automaticos es de $1.200.000.</li>
                    <li>El monto maximo de compras diarias en la red de datafonos es de $2.000.000.</li>
                </ul>
            </div> <!--pagina caracteristicas medios de pago  -->
            <br/>
            <div>
            ...
            <div > <!-- Otros costos asociados-->
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <li>Transaccion no exitosa (Fondos insuficientes - Pin Errado)<sup>1</sup> </li>
                        </td>
                        <td>
                            $   3.540
                        </td> 
            ...
            <?php  if ($cantlineas >= 1 && $cantlineas <= 5) { ?>
                ...
                <div>
                    <p class="text-10px" >
                        ...
                        No est&aacute; permitida la reproduccion total o parcial de este documento, ni su tratamiento informatico, ni la transmision de ninguna forma o por cualquier medio, ya sea electronico o mec&aacute;nico, por fotocopia, por registro u otros m&eacute;todos, sin el permiso previo y por escrito de los titulares.
                    </p>
                    <p style="text-align:right;" class="text-10px">People Pass S.A<br>
                        Bogot&aacute;, Colombia, Sur America<br>
                    </p>
                </div>
            ...
            <?php } elseif(($cantlineas >= 16 && $cantlineas <= 20)){ ?>
                ...
                <div>
                    <p class="text-10px" >
                        Derechos Reservados 2011, PEOPLEPASS S.A.<br>
                        No esta permitida la reproduccion total o parcial de este documento, ni su tratamiento inform&aacute;tico, ni la transmision de ninguna forma o por cualquier medio, ya sea electr&oacute;nico o mec&aacute;nico, por fotocopia, por registro u otros m&eacute;todos, sin el permiso previo y por escrito de los titulares.
                    </p>
                    <p style="text-align:right;" class="text-10px">People Pass S.A<br>
                        Bogota, Colombia, Sur America<br>
                    </p>
                </div>
             <?php } ?>  
        </div>
