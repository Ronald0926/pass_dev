                ...
                <form method="post" action="solicitud" id="formSolicitudUno" >
                    ...
                    <div class="col-sm-6">
                        ...
                        <div id="seccion-recargar">
                            ...
                            <input type="text" pattern="^3[0-9]{9}" maxlength="10" class="telefono" name="telefono" id="telefono" placeholder="Teléfono Celular" autocomplete="nope" onselectstart="return false" onpaste="return false;" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" title="Ejemplo 3001112233 " required>
        ...
        <div class="modal fade" id="modalCampos" role="dialog" style="    margin-top: 15%;">
            <div class="modal-dialog">
                ...
                <div class="modal-content" style="border-radius:35px">
                    ...
                    <div class="modal-body" style="text-align: center;height: auto;">
                        <div class="modal-header" style="padding:0px">
                            <h5 style="color: #366199;font-size: 24px;font-weight: bold; ">Formulario inválido</h5>
                        </div>
                        <div>
                            <br>    
