...
<div style=" margin-bottom: 200px; margin-top: -50px;">
    <div class="container">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="active" id="solicitudMasiva "><a  href="/portal/solicitudTarjetas/solicitudTarjetasMasivouau">Envios Personalizados</a></li>
        </ul>

        <div class="tab-content">
            <div id="solicitudMasiva" class="tab-pane fade in active">
                <h3>Env&iacute;os personalizados de tarjetas solicitadas</h3>
                <p>Una vez hayas hecho t&aacute; solicitud de tarjetas individual o masiva y desees enviar una o varias de las tarjetas solicitadas a una direcci&oacute;n espec&iacute;fica que no sea la de tus custodios.</p>
                <p>Debes descargar y diligenciar la plantilla, con las tarjetas y los datos del destinatario, subi&eacute;ndola y envi&aacute;ndola desde la plataforma.</p>
                <div class="col-sm-4">
                    <table id="masivoIconos" cellspacing="10" cellpadding="10" border="0">
                        <tbody>
                            <tr>
                                <p>Env&iacute;o personalizado de tarjetas</p>
                            </tr>
                            <tr>
                                <td>
                                    <a href="/portal/solicitudTarjetas/descargarPlantillaUnoAUno" > <div class="excel-new"></div> </a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="button" >
                                        <button style="max-width: 245px;" data-toggle="modal" data-target="#ModalConfSolMasiuau">Enviar Plantilla Subida</button>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
...
<?php } ?>  
<div class="modal fade" id="myModalokunoauno" role="dialog" style="    margin-top: 5%;">
            <div class="modal-dialog">
                <div class="modal-content" style="border-radius:35px">
                    <button class="btn_cerrar_modal" data-dismiss="modal"></button>
                    <div class="modal-body" style="text-align: center;height: auto;">
            ...
            <div class="modal-body" style="text-align: center;height: auto;">
                ...
                <div style=" margin-bottom: 4em">
                    <div class="button col-sm-6" >
                        <button type="button" name="ACEPTAR"  value="1" class="btn btn-default spacing" id="btnLACEPTAR1"  onclick="
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content" style="border-radius:35px">
            ...
            <div class="modal-body" style="text-align: center;height: auto;">
                ...
                <div style=" margin-bottom: 4em">
                    <div class="button col-sm-6" >
                        <button type="button" name="ACEPTAR" value="1" id="btnLACEPTAR2" class="btn btn-default spacing"  onclick="
...
<script type="text/javascript">
                            ...
                            $("#solicitudMasiva").submit(function () {
                                $('#loader').modal('show');
                                $('#btnLACEPTAR1')..attr("disabled", true);
                            });


                            $("#solicitudMas").submit(function () {
                                $('#loader').modal('show');
                                $('#btnLACEPTAR2')..attr("disabled", true);
                            });
                            var x = "<?= $ok ?>";
                            if (x == "1") {
