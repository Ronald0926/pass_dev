...
<div style="padding-left:  10%">
    ...
    <div class="col-lg-5 col-a">
        ...
        <br>
        <a href="/portal/soporte/facturas2" class="a_selected"><span class="online-number online-numerselected">2</span>Anulación de factura</a>
        <br>
    ...
    <div class="col-lg-4" style="margin-top: 80px">
        <form method="POST" >
            ...
            <input type="text" style="padding-left:10px" class="numPat" name="valnotcre" placeholder="Ingrese valor de la nota crédito*" value="" required><br><br>
            <div class="row">
