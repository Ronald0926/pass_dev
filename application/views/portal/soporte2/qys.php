...
<div style="padding-left:  10%">
    ...
    <div class="col-lg-5">
        <form method="POST" >
            ...
            <textarea rows="5" class="" maxlength="3500" style="width:100%;border-radius:10px;padding-left:10px"name="desc" placeholder="Descripción*" value="" required></textarea><br>
