...
<div style="padding-left:  10%">
    ...
    <div class="col-lg-5 col-a">
        ...
        <br>
        <a href="/portal/soporte/abonos3" class="a_selected"><span class="online-number online-numerselected">3</span>Anticipo con extracupo</a>
        <br>
    ...
    <div class="col-lg-4">
        <form method="POST" >
            ...
            <textarea rows="5" style="width:100%;border-radius:10px;padding-left:10px" name="motivo" class="" maxlength="3500" placeholder="Motivo por el excede el cupo aprobado*" value="" required></textarea><br>
