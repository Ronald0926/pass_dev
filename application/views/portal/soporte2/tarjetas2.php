...
<div style="padding-left:  10%;padding-bottom:270px;margin-bottom:210px">
    ...
    <div class="col-lg-5 col-a">
        ...
        <br>
        <a href="/portal/soporte/tarjetas2" class="a_selected"><span class="online-number online-numerselected">2</span>Cancelación definitiva de tarjeta</a>
        <br>
    ...
    <div class="col-lg-4">
        <form method="POST" >
            ...
            <input type="email" pattern="[A-Za-z0-9._%+-]{3,}@[A-Za-z]{3,}\.[A-Za-z]{2,}(?:\.[A-Za-z]{2,})?" style="padding-left:10px" name="correo" placeholder="Correo electrónico de contacto*" value="" required><br><br>
            ...
            <input type="text" class="textPat" style="padding-left:10px" name="prod" placeholder="Producto*" value="" required><br>
            ...
            <textarea rows="5" class="" style="width:100%;border-radius:10px;padding-left:10px"name="desc" placeholder="Descripción*" maxlength="3500" value="" required></textarea><br>
