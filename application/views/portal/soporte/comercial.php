...
<div style="padding-left:  10%">
    ...
    <div class="col-lg-4">
        <form method="POST" >
            ...
            <textarea rows="5" style="width:100%;border-radius:10px;padding-left:10px"name="desc" placeholder="Descripción" value="" maxlength="2000" class="" required></textarea><br>
