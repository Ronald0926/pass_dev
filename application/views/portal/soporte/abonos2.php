...
<div style="padding-left:  10%">
    ...
    <div class="col-lg-4">
        <form method="POST" >
            ...
            <textarea rows="5" style="width:100%;border-radius:10px;padding-left:10px"name="motivo" class="" maxlength="2000" placeholder="Motivo por el no pago de las facturas" value=""></textarea><br><br>
            <textarea rows="5" style="width:100%;border-radius:10px;padding-left:10px"name="compromiso" class="" maxlength="2000" placeholder="Compromiso de pago de facturas" value=""></textarea><br>
