...
<div style="padding-left:  10%">
    ...
    <div class="col-lg-4">
        <form method="POST" >
            ...
            <input type="number" style="padding-left:10px" name="tarjeta" class="numPat" placeholder="Número de tarjeta (últimos 4 dígitos)" value="" required><br>
            ...
            <textarea rows="5" class="" style="width:100%;border-radius:10px;padding-left:10px"name="desc" maxlength="2000" placeholder="Descripción" value="" required></textarea><br>
