...
<div style="padding-left:  10%">
    ...
    <div class="col-lg-4">
        <form method="POST" >
            ...
            <textarea rows="5" class="" style="width:100%;border-radius:10px;padding-left:10px"name="desc" placeholder="Descripción" required maxlength="2000" value=""></textarea><br>
